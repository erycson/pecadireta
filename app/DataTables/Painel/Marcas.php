...
use App\Models\Marca as Model;

class Marcas extends DataTable
{
    /**
    ...
    {
        return $model->withCount('pecas')->newQuery();
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('pecas')->title('Total de Peças'),
