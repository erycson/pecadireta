<x-painel.dash-layout>
    <x-breadcrumb :items="[['title' => 'CEPs', 'painel.ceps.index'], ['title' => 'Cadastrar']]" />
        ...
        <div class="row g-3 g-lg-4">
            <div class="col-12">
                <div class="row justify-content-between align-items-center">
                    <div class="col-auto">
                        <span class="h4">Cadastrar CEP</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card h-100 rounded-3">
                    ...
                    <div class="card-body px-4">
                        {!! Form::open(['url' => route('painel.ceps.store'), 'class' => 'row g-4 needs-validation', 'novalidate']) !!}
